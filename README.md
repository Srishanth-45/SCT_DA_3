...
## Task Objective
Build an interactive Power BI dashboard to analyze employee attrition and identify the main factors influencing employee turnover.
...
- Employees aged 25–34 have the highest turnover.
